...
- (void)viewDidLoad{
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(2 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
       ...
       [YQAnimationLayer createAnimationLayerWithString:@"520 + 1  请点击" andRect: CGRectMake(0,250, self.view.frame.size.width, self.view.frame.size.width) andView:self.view andFont:[UIFont boldSystemFontOfSize:30] andStrokeColor:[UIColor cyanColor]];
    });
}
